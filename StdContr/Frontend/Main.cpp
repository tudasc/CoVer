...
class FuncDeclAction : public PluginASTAction {
  public:
    std::unique_ptr<ASTConsumer> CreateASTConsumer(CompilerInstance& CI, llvm::StringRef) override { return std::make_unique<FuncDeclConsumer>(CI,output_path); }
...
static FrontendPluginRegistry::Add<FuncDeclAction> X("CoVerStdCXXFrontend", "Transform CoVer to C++26 contracts, and generate wrapper files as necessary");
