...
// (Constint) Values needed for contracts
...
// (Ptr) Values needed for contracts
CONTRACT_PTR_PAIR(NULL, *NULL)
CONTRACT_PTR_PAIR(MPI_IN_PLACE,*MPI_IN_PLACE)
CONTRACT_PTR_PAIR(MPI_REQUEST_NULL,*MPI_REQUEST_NULL)
CONTRACT_PTR_PAIR(MPI_OP_NULL,*MPI_OP_NULL)
CONTRACT_PTR_PAIR(MPI_COMM_NULL,*MPI_COMM_NULL)
